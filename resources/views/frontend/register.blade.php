...
@csrf
                                <div class="form-group">
                                    ...
                                    <input class="au-input au-input--full" value="{{old('first_name')}}" type="text" name="first_name" placeholder="Username">
                                </div>
                                <div class="form-group">
                                    <label>Last Name</label>
                                    <input class="au-input au-input--full" value="{{old('last_name')}}" type="text" name="last_name" placeholder="Username">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="au-input au-input--full" value="{{old('password_confirmation')}}" name="password_confirmation" type="password" placeholder="Password">
                                </div>
